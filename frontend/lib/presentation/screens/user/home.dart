 ...
 List text1=['Why use Pilot for Your Investment','123','456'];
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: CarouselSlider(items:[for(int i=0;i<5;i++)Container(//color: Colors.black,
                          width: Get.width*0.2,
                          child: Center(child: Text('profile ${i}',style: TextStyle(color: Colors.white),)),)], 
                          options:CarouselOptions(
                            height: 200.0,
                            autoPlay: true,
                             autoPlayInterval: Duration(seconds: 1), // Time before moving to next slide
                            ...
                            child: const Icon(Icons.location_city),),
                              ...
                              const Column(
                                children: [
                                  ...
                                  Text("Cities", style: TextStyle(fontSize: 18),),
                                ],
                              ),
                            ],
                          ),
  ...
  child: CircleAvatar(
    ...
    child: Center(child: Text('$index')),
                                    ...
                                    Text(City[index], style: TextStyle(fontSize: 12),),
                                  ],
                                ),
                              );
                            }
